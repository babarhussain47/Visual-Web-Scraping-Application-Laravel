					...
					<table class="table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$package->p_allowed_request_rem}}</td>
                                    </tr>
									...
									@if($package->p_allowed_api)
                                        ...
                                        <td>{{$package->p_allowed_api_request}}</td>
										 <tr>
                                        <th>Remaining API Calls</th>
                                        <td>{{$package->p_allowed_api_request_rem}}</td>
                                    </tr>
								...
								<span class="btn btn-info" id="package_{{$package->p_id}}" onclick="submitForm(this)">Buy Again</span>
